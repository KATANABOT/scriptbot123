...
console.log(color('Instagram :', 'cyan'), color(`@ryarllh_01`, 'yellow'))
console.log(color('Github :', 'cyan'), color(`RikMD`, 'yellow'))
console.log(color('Wangsap :', 'cyan'), color(`087741097274`, 'yellow'))
...
*𝐖𝐀𝐑𝐍𝐈𝐍𝐆!!!*
𝙄𝙉𝙏𝙍𝙊 𝙏𝙄𝘿𝘼𝙆 𝘽𝙄𝙎𝘼 𝘿𝙄 𝙎𝘼𝙇𝙄𝙉
𝙅𝘼𝘿𝙄 𝙇𝘼𝙉𝙂𝙎𝙐𝙉𝙂 𝙎𝘼𝙅𝘼 𝙆𝙀𝙏𝙄𝙆
...
*𝐓𝐇𝐀𝐍𝐊 𝐀𝐋𝐋 ❤*` })
                    ...
                    sock.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} 𝙈𝙤𝙝𝙤𝙣 𝙠𝙚𝙩𝙞𝙙𝙖𝙠𝙣𝙮𝙖𝙢𝙖𝙣𝙖𝙣 𝙖𝙣𝙙𝙖 ${metadata.subject}` })
                }
            }
        } catch (err) {
            console.log(err)
